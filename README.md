...
├── hardware/
│   ├── power_stage.md         ← what we just decided (MOSFET, diode, LM5106, bootstrap, etc.)
│   ├── BOM.md                 ← full parts list table
│   ├── schematics/            ← (we’ll add KiCad files here later)
│   └── notes/                 ← any hand sketches or explanations
├── software/                  ← C2000 code (coming soon)
├── docs/                      ← control laws, theory, etc.
└── .gitignore
